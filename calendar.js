...
Calendar.prototype = {
	init: function() {
		...
		this.contains.className = 'dt-datepicker-container';
		this.dateInput.className = 'dt-date-input';
		// this.dateInput.readOnly = true; //只读
	      ...
	      */
	      if (e.path) {
	        ...
	        for (var i = 0; i < e.path.length; i++) {
	          pathClass += e.path[i].className
	        }
	        if (pathClass.indexOf('dt-datepicker-container') < 0) {
				document.querySelector('.dt-date-picker').style.display = 'none'
	        }
	      }
	    })
		this.datePicker.className = 'dt-date-picker';
		this.datePicker.style.display = 'none';
		this.showDateBar.className = 'dt-show-date';
		this.dateBox.className = 'dt-date-box';
		this.icon.className = 'dt-date-icon';
